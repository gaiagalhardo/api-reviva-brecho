...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleErrorMaxUpload(MaxUploadSizeExceededException ex, WebRequest request) {

		HttpStatus status = HttpStatus.EXPECTATION_FAILED;
		ProblemType problemType = ProblemType.TAMANHO_MAXIMO_UPLOAD;
		String detail = String.format(
				"Tamanho máximo de upload do arquivo foi excedido. Por favor, selecione um arquivo de até 10MB");
	...
	public ResponseEntity<?> handleEntidadeEmUso(EntidadeEmUsoException ex, WebRequest request) {
		...
		String detail = ex.getMessage();
		// String detail = "A entidade não pode ser excluída, pois está em uso.";
